...
public:
     ...
     */
    static void gotoPoint(Geometry::Point *point, float speed, std::function<void ()> funcFinish);
     ...
     * @param funcFinish функция вызываемая при окончании перемещения
     */
    static void gotoPoint(Geometry::PointXY *point, float speed, std::function<void ()> funcFinish);
     ...
     * @param funcFinish функция вызываемая при окончании перемещения
     */
    static void circle(Geometry::CircleSegment *circle, float speed, std::function<void ()> funcFinish);
